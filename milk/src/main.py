...
Number.null = Number(0) # type: ignore
Number.false = Number(0) # type: ignore
Number.true = Number(1) # type: ignore
Number.math_PI = Number(math.pi) # type: ignore
...
class BaseFunction(Value):
    ...
    def generate_new_context(self):
        ...
        new_context.symbol_table = SymbolTable(new_context.parent.symbol_table) # type: ignore
        return new_context
...
class Function(BaseFunction):
    ...
    def execute(self, args):
        ...
        ret_value = (
            value if self.should_auto_return else None) or res.func_return_value or Number.null # type: ignore
...
class BuiltInFunction(BaseFunction):
    ...
    def execute(self, args):
        ...
        res.register(self.check_and_populate_args(
            method.arg_names, args, exec_ctx)) # type: ignore
        if res.should_return():
            return res
    ...
    def execute_is_number(self, exec_ctx):
        ...
        return RTResult().success(Number.true if is_number else Number.false) # type: ignore
...
BuiltInFunction.print_ret = BuiltInFunction("print_ret") # type: ignore
BuiltInFunction.input = BuiltInFunction("input") # type: ignore
BuiltInFunction.input_int = BuiltInFunction("input_int") # type: ignore
BuiltInFunction.clear = BuiltInFunction("clear") # type: ignore
BuiltInFunction.is_number = BuiltInFunction("is_number") # type: ignore
BuiltInFunction.is_string = BuiltInFunction("is_string") # type: ignore
BuiltInFunction.is_list = BuiltInFunction("is_list") # type: ignore
BuiltInFunction.is_function = BuiltInFunction("is_function") # type: ignore
BuiltInFunction.append = BuiltInFunction("append") # type: ignore
BuiltInFunction.pop = BuiltInFunction("pop") # type: ignore
BuiltInFunction.extend = BuiltInFunction("extend") # type: ignore
BuiltInFunction.len = BuiltInFunction("len") # type: ignore
BuiltInFunction.run = BuiltInFunction("run") # type: ignore
...
global_symbol_table.set("MATH_PI", Number.math_PI) # type: ignore
global_symbol_table.set("PRINT", BuiltInFunction.print) # type: ignore
global_symbol_table.set("PRINT_RET", BuiltInFunction.print_ret) # type: ignore
global_symbol_table.set("INPUT", BuiltInFunction.input) # type: ignore
global_symbol_table.set("INPUT_INT", BuiltInFunction.input_int) # type: ignore
...
global_symbol_table.set("IS_NUM", BuiltInFunction.is_number) # type: ignore
global_symbol_table.set("IS_STR", BuiltInFunction.is_string) # type: ignore
global_symbol_table.set("IS_LIST", BuiltInFunction.is_list) # type: ignore
global_symbol_table.set("IS_FUN", BuiltInFunction.is_function) # type: ignore

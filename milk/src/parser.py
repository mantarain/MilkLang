...
class Parser:
  ...
  def comp_expr(self):
    ...
    node = res.register(self.bin_op(self.arith_expr, (Tk_DoubleEquals, Tk_NotEquals, Tk_LessThan, Tk_MoreThan, Tk_LessThanEquals, Tk_MoreThanEquals)))
